package com.yj.jason.baselibrary.view;
...
public class TabLayoutView extends LinearLayout {
    ...
    public void initDatas()
    {
        ...
        for(int i = 0; i < size; i++)
        {
            ...
            tvDot.setTextColor(context.getResources().getColor(R.color.color_ffffff));
            tvDot.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.dot_circle));
